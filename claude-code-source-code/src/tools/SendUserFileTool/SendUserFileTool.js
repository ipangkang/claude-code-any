...
export const NAME = 'SendUserFileTool'
export const TOOL_NAME = 'SendUserFileTool'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const SendUserFileTool = { name: 'SendUserFileTool', isEnabled: () => false, call: noop }
