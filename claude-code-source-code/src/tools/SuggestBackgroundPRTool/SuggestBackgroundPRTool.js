...
export const NAME = 'SuggestBackgroundPRTool'
export const TOOL_NAME = 'SuggestBackgroundPRTool'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const SuggestBackgroundPRTool = { name: 'SuggestBackgroundPRTool', isEnabled: () => false, call: noop }
