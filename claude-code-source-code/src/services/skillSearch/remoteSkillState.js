...
export const NAME = 'remoteSkillState'
export const TOOL_NAME = 'remoteSkillState'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const remoteSkillState = { name: 'remoteSkillState', isEnabled: () => false, call: noop }
