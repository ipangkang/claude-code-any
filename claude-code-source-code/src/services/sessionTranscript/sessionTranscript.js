...
export const NAME = 'sessionTranscript'
export const TOOL_NAME = 'sessionTranscript'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const sessionTranscript = { name: 'sessionTranscript', isEnabled: () => false, call: noop }
