...
export const NAME = 'cachedMicrocompact'
export const TOOL_NAME = 'cachedMicrocompact'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const cachedMicrocompact = { name: 'cachedMicrocompact', isEnabled: () => false, call: noop }
