...
export const NAME = 'WorkflowDetailDialog'
export const TOOL_NAME = 'WorkflowDetailDialog'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const WorkflowDetailDialog = { name: 'WorkflowDetailDialog', isEnabled: () => false, call: noop }
