...
export const NAME = 'MonitorMcpDetailDialog'
export const TOOL_NAME = 'MonitorMcpDetailDialog'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const MonitorMcpDetailDialog = { name: 'MonitorMcpDetailDialog', isEnabled: () => false, call: noop }
