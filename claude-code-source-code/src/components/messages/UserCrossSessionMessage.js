...
export const NAME = 'UserCrossSessionMessage'
export const TOOL_NAME = 'UserCrossSessionMessage'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const UserCrossSessionMessage = { name: 'UserCrossSessionMessage', isEnabled: () => false, call: noop }
