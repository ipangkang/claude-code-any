...
export const NAME = 'UserForkBoilerplateMessage'
export const TOOL_NAME = 'UserForkBoilerplateMessage'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const UserForkBoilerplateMessage = { name: 'UserForkBoilerplateMessage', isEnabled: () => false, call: noop }
