...
export const NAME = 'UserGitHubWebhookMessage'
export const TOOL_NAME = 'UserGitHubWebhookMessage'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const UserGitHubWebhookMessage = { name: 'UserGitHubWebhookMessage', isEnabled: () => false, call: noop }
