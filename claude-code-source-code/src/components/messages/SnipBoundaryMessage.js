...
export const NAME = 'SnipBoundaryMessage'
export const TOOL_NAME = 'SnipBoundaryMessage'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const SnipBoundaryMessage = { name: 'SnipBoundaryMessage', isEnabled: () => false, call: noop }
