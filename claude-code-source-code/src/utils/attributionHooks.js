...
export const NAME = 'attributionHooks'
export const TOOL_NAME = 'attributionHooks'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const attributionHooks = { name: 'attributionHooks', isEnabled: () => false, call: noop }
