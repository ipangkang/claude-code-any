...
export const NAME = 'protectedNamespace'
export const TOOL_NAME = 'protectedNamespace'
export const clearSkillIndexCache = noop
export const initBundledWorkflows = noop
export const protectedNamespace = { name: 'protectedNamespace', isEnabled: () => false, call: noop }
